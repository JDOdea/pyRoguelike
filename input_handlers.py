...
MOVE_KEYS = {
    ...
    tcod.event.KeySym.KP_5: (1, 0),
    tcod.event.KeySym.KP_6: (-1, -1),
    tcod.event.KeySym.KP_7: (0, -1),
...
class PopupMessage(BaseEventHandler):
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        """Render the parent and dim the result, the print the message on top."""
